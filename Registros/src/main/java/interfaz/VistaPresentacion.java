...
public class VistaPresentacion extends javax.swing.JFrame {
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        ...
        boolean camposCompletos = !codigo.isEmpty() && !nombre.isEmpty() && !apellido.isEmpty() && fechaNacimiento != null;
        ...
        String fechaFormateada = new SimpleDateFormat("dd/MM/yyyy").format(fechaNacimiento);

        // Agregar los datos de la persona a la tabla
        Object[] datosPersona = {codigo, nombre, apellido, fechaFormateada};
...
// Actualizar los valores en la tabla
        int columna = 0;
        modeloTabla.setValueAt(codigo, selectedRow, columna++);
        modeloTabla.setValueAt(nombre, selectedRow, columna++);
        modeloTabla.setValueAt(apellido, selectedRow, columna++);
        modeloTabla.setValueAt(fechaFormateada, selectedRow, columna);
...
// Eliminar todas las filas del modelo de la tabla
        while (rowCount-- > 0) {
            modeloTabla.removeRow(rowCount);
        }
